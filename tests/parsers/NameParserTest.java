...
public class NameParserTest {
    ...
    public void getLastNames() {
        String fieldValue = "Stas Stan von Me best Shelemekh Kulpa and kon Pon don Slowiak, Kuba and qon Son ron Balicka, Dr Nive, Alina and Stas Shelemekh";
        ...
        assertEquals(new Name("Stas~", "Shelemekh~", null, null), names.get(3));
